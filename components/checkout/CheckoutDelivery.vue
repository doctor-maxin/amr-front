...
<template>
	<div class="card">
		<h3 class="font-semibold text-system-black-950 mb-[1.125rem] lg:mb-6 lg:text-2xl">Способы получения</h3>
		<div class=" grid grid-cols-1 grid-rows-[auto_minmax(0,_1fr)] max-h-full w-full flex-1" v-bind="api.rootProps">
			<div class="bg-system-gray mb-[1.125rem] lg:mb-6 rounded-[5rem] p-[5px]  flex items-center"
