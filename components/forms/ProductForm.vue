		...
		<Transition name="fade">
			...
			>
				<div
					...
					class="bg-white w-screen relative h-screen max-h-[90vh] max-w-[36rem] lg:max-h-[34.375rem] rounded-t-[1rem] lg:rounded-[2rem] lg:p-9"
				>
					<form
						v-if="product"
...
import { computed, ref, useAppConfig, useForm } from "#imports";
