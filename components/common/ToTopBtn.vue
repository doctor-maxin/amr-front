...
<template>
	...
	<transition name="fade">
		<button type="button" title="Наверх"
			class="fixed z-[19] shadow shadow-white hidden lg:flex flex-col items-center justify-center rounded-full shadow-normal right-3 bottom-20 lg:right-[5rem] lg:bottom-[8rem]"
