...
const {errorMessage, handleChange, value: count, } = useField(() => `product-${props.line.id}`, undefined, {
...
<template>
	...
	<div
		...
		<button class="w-10 h-[2.5rem] lg:h-[3.375rem] lg:w-[3.375rem] flex items-center justify-center"
		        type="button" @click="removeMore">
			<svg fill="none" height="3" viewBox="0 0 10 3" width="10" xmlns="http://www.w3.org/2000/svg">
				<path d="M0 3V0H10V3H0Z" fill="currentColor"/>
			</svg>
		</button>
		<input v-model.number="count" :max="line.product.count"
